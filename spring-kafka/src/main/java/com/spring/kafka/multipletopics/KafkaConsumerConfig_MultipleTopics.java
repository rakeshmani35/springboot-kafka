...
@Configuration
public class KafkaConsumerConfig_MultipleTopics {

    @Value(value = "${spring.kafka.bootstrap-servers}")
    private String bootstrapServers;

    @Bean(name = "ConsumerFactory_MultipleTopics")
    ...
    @Bean(name = "ConcurrentKafkaListenerContainerFactory_MultipleTopics")
