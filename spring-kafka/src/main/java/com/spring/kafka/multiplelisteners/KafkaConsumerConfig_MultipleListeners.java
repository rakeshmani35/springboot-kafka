...
@EnableKafka
@Configuration
public class KafkaConsumerConfig_MultipleListeners {

    private static final Logger LOGGER = LoggerFactory.getLogger(KafkaConsumerConfig_MultipleListeners.class);
    ...
    public ConsumerFactory<String, BookEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.TYPE_MAPPINGS, "bookEvent:com.spring.kafka.multiplelisteners.BookEvent");

        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean(name = "ConcurrentKafkaListenerContainerFactory_MultipleListeners")
