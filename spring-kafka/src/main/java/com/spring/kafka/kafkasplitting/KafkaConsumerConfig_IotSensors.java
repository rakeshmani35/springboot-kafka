...
@PropertySource(value = {"classpath:application.properties","classpath:application-managed.properties"})
@Configuration
class KafkaConsumerConfig_IotSensors {
    ...
    @Bean(name = "ConsumerFactory_IotSensors")
    ...
    @Bean(name = "KafkaListenerContainerFactory_IotSensors")
